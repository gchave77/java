...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        udemy_exercises.songs.Album album = new udemy_exercises.songs.Album("Stormbringer", "Deep Purple");
        ...
        album = new udemy_exercises.songs.Album("For those about to rock", "AC/DC");
