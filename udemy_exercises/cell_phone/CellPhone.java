...
public class CellPhone {
    ...
    public String queryContact(udemy_exercises.cell_phone.Contact contact) {
    ...
    public udemy_exercises.cell_phone.Contact queryContact(String name) {
...
**Cell Phone with Java Classes**
    - **CellPhone Class:**
      ...
      * **Be sure not to expose the inner workings of the Arraylist to CellPhone (use concepts of encapsulation to meet this requirement)**
*/
